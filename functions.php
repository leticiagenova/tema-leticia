...
Rye::init(array(
   ...
   */
    'javascripts' => array(
        ...
        'owl.carousel'   =>  get_bloginfo('template_directory').'/assets/js/vendor/owl.carousel.min.js',
        'fancybox'   =>  get_bloginfo('template_directory').'/assets/js/vendor/jquery.fancybox.pack.js',
...
function renderMenu($name, $currentPageID = 0){
  if ( ( $locations = get_nav_menu_locations() ) && isset( $locations[ $name ] ) ) {
    ...
    foreach ( (array) $menu_items as $key => $menu_item ) {
      ...
      $url = $menu_item->url;
      $active = $currentPageID == $menu_item->ID ? 'active' : '';
